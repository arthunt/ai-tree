...
## 🌳 AI TREE PROJECT CONTEXT

**Project:** AI Tree (AI Teadmiste Puu / Dendrix.ai)
...
- `backlog` - Project backlog summary
- `tech-decisions` - Architecture decisions
- `progress-[epic]` - Epic completion status

### 🔄 Before Starting Work
```bash
# Load backlog context
claude-flow memory search --query "backlog priorities"
# Check current sprint
cat /Users/ak/GitHub/ai-tree/.claude-flow/backlog.json | jq '.current_sprint'
```
