    ...
    <div className={`${className} text-gray-900 dark:text-gray-100`}>
      <svg viewBox="0 0 750 550" className="w-full h-auto" xmlns="http://www.w3.org/2000/svg">
        ...
        <g>
          ...
          <text x="130" y="365" fontSize="13" fontWeight="bold" fill="currentColor">Be specific</text>
          <text x="130" y="382" fontSize="11" fill="currentColor" opacity="0.8">State exactly what you want</text>
        </g>
        ...
        <g>
          ...
          <text x="450" y="365" fontSize="13" fontWeight="bold" fill="currentColor">Give context</text>
          <text x="450" y="382" fontSize="11" fill="currentColor" opacity="0.8">Provide relevant background</text>
        </g>
        ...
        <g>
          ...
          <text x="130" y="420" fontSize="13" fontWeight="bold" fill="currentColor">Set format</text>
          <text x="130" y="437" fontSize="11" fill="currentColor" opacity="0.8">Specify output structure</text>
        </g>
        ...
        <g>
          ...
          <text x="450" y="420" fontSize="13" fontWeight="bold" fill="currentColor">Use examples</text>
          <text x="450" y="437" fontSize="11" fill="currentColor" opacity="0.8">Show what you mean</text>
        </g>
        ...
        <g>
          ...
          <text x="290" y="475" fontSize="13" fontWeight="bold" fill="currentColor">Break complex tasks</text>
          <text x="290" y="492" fontSize="11" fill="currentColor" opacity="0.8">Split into smaller steps</text>
        </g>
      </svg>
    </div>
  );
