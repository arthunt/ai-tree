  ...
  return (
    <div className={`${className} text-gray-900 dark:text-gray-100`}>
      <svg viewBox="0 0 650 450" className="w-full h-auto" xmlns="http://www.w3.org/2000/svg">
        ...
        <text x="150" y="145" fontSize="14" fontWeight="bold" fill="currentColor" textAnchor="middle">Layer 1</text>
        <text x="150" y="164" fontSize="11" fill="currentColor" opacity="0.7" textAnchor="middle">Frozen weights</text>
        <text x="92" y="140" fontSize="20" fill="#3b82f6">❄️</text>
        ...
        <text x="150" y="240" fontSize="14" fontWeight="bold" fill="currentColor" textAnchor="middle">Layer 2</text>
        <text x="150" y="259" fontSize="11" fill="currentColor" opacity="0.7" textAnchor="middle">Frozen weights</text>
        <text x="92" y="235" fontSize="20" fill="#3b82f6">❄️</text>
        ...
        <text x="150" y="335" fontSize="14" fontWeight="bold" fill="currentColor" textAnchor="middle">Layer 3</text>
        <text x="150" y="354" fontSize="11" fill="currentColor" opacity="0.7" textAnchor="middle">Frozen weights</text>
        <text x="92" y="330" fontSize="20" fill="#3b82f6">❄️</text>
        ...
        {/* Input/Output labels */}
        <text x="150" y="105" fontSize="11" fill="currentColor" opacity="0.6" textAnchor="middle">Input</text>
        <text x="150" y="390" fontSize="11" fill="currentColor" opacity="0.6" textAnchor="middle">Output</text>
