...
interface McpArchitectureSVGProps {
  className?: string;
}

export function McpArchitectureSVG({ className = '' }: McpArchitectureSVGProps) {
  return (
    <div className={`text-gray-900 dark:text-gray-100 ${className}`}>
      ...
      >
        ...
        <text x="125" y="105" textAnchor="middle" fontSize="13" fontWeight="600" fill="#3b82f6">
          AI
        </text>
        ...
        {/* Spaghetti connections (gray messy lines) */}
        ...
        <text x="365" y="105" textAnchor="middle" fontSize="13" fontWeight="600" fill="#3b82f6">
          AI
        </text>
