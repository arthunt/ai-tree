...
export function ProgramPricing({ program, labels }: ProgramPricingProps) {
            ...
            <div className="container mx-auto px-4 max-w-5xl relative">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="relative p-8 rounded-3xl bg-zinc-900 border border-white/10 shadow-2xl">
                        ...
                        <button
                            className="w-full py-4 rounded-xl font-bold text-lg mb-4 hover:scale-[1.02] active:scale-[0.98] transition-all shadow-lg"
                            style={{
