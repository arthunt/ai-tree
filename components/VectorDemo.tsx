...
const WORD_EMBEDDINGS: Record<string, number[]> = {
  ...
  // Estonian Aliases (mapping to same vectors)
  'kuningas': [0.00, 0.01, 0.00, 0.04, 0.01, 0.00, 0.96, 0.35, 0.02, 0.03], // king
  'kuninganna': [0.17, 0.12, 0.26, 0.00, 0.00, 0.07, 0.98, 0.03, 0.08, 0.00], // queen
  'prints': [0.72, 0.62, 0.49, 0.14, 0.22, 0.69, 0.56, 0.67, 0.75, 0.70], // prince
  'printsess': [0.86, 0.68, 0.21, 0.30, 0.73, 0.56, 0.27, 0.09, 0.92, 0.59], // princess
  'kroon': [0.02, 0.00, 0.24, 0.08, 0.09, 0.08, 0.93, 0.50, 0.64, 0.51], // crown
  'troon': [0.00, 0.10, 0.00, 0.00, 0.07, 0.00, 0.97, 0.34, 0.85, 0.02], // throne

  'kass': [0.93, 0.91, 0.10, 0.04, 0.76, 0.02, 0.64, 0.04, 0.00, 0.05], // cat
  'koer': [0.97, 0.99, 0.21, 0.27, 0.51, 0.62, 0.08, 0.04, 0.05, 0.17], // dog
  'auto': [0.01, 0.01, 0.39, 0.85, 0.01, 0.03, 0.04, 0.86, 0.03, 0.00], // car

  'rõõmus': [0.08, 0.30, 0.02, 0.02, 0.92, 0.63, 0.77, 0.01, 0.70, 0.73], // happy
  'kurb': [0.65, 0.25, 0.89, 0.08, 0.74, 0.09, 0.02, 0.01, 0.00, 0.01], // sad
  'vihane': [0.09, 0.03, 0.93, 0.98, 0.82, 0.06, 0.97, 0.11, 0.07, 0.04], // angry

  'õun': [0.00, 0.94, 0.17, 0.01, 0.05, 0.93, 0.25, 0.39, 0.19, 0.65], // apple
  'banaan': [0.01, 0.80, 0.00, 0.01, 0.00, 0.41, 0.01, 0.13, 0.33, 0.30], // banana
  'pitsa': [0.01, 0.08, 0.21, 0.07, 0.02, 0.94, 0.04, 0.03, 0.99, 0.96], // pizza

  'arvuti': [0.00, 0.01, 0.04, 0.04, 0.00, 0.01, 0.08, 0.48, 0.82, 0.01], // computer
  'telefon': [0.07, 0.93, 0.86, 0.00, 0.03, 0.76, 0.52, 0.24, 0.10, 0.01], // phone
  'puu': [0.89, 0.01, 0.00, 0.80, 0.90, 0.03, 0.04, 0.02, 0.31, 0.86], // tree
};
                  ...
                  <div className="flex items-center gap-2">
                    <div className="w-16 sm:w-24 bg-gray-200 dark:bg-gray-700 rounded-full h-1.5 overflow-hidden">
                      <motion.div
                        ...
                        className={`h-full ${result.similarity > 0.7
                            ? 'bg-green-500'
